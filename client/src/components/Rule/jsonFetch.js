...
import { Row as AntRow, Col, Space, Form, Input, Button, Radio } from 'antd';
...
const JsonFetch = ({
    ...
    const retrieve = () => {
        https.get(ruleForm.getFieldValue('webhookAddress'), function (res) {
